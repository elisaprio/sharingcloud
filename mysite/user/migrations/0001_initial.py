# Generated by Django 2.1.7 on 2019-11-26 21:31

import django.db.models.deletion
from django.conf import settings
from django.db import migrations, models

from user.models import ALL_TIMEZONES


def create_timezones(apps, schema_editor):
    MyttimezoneTable = apps.get_model("user", "MytimezoneTable")
    db_alias = schema_editor.connection.alias
    MyttimezoneTable.objects.using(db_alias).bulk_create(
        [MyttimezoneTable(tz_name=key) for (key, value) in ALL_TIMEZONES]
    )
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tz', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                         to='user.MytimezoneTable')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.RunPython(create_timezones, migrations.RunPython.noop)
    ]
